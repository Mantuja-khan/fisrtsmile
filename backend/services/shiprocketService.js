...
//   try {
//     console.log(
//       `📦 Initializing automated Shiprocket handoff for order ${orderDoc?.order_number || orderDoc?._id}...`,
//     );
...
const getShiprocketToken = async () => {
  ...
  if (!email || !password) {
    console.error("⚠️ Shiprocket credentials missing!");
    return null;
  }
  ...
  try {
    ...
    try {
      ...
      console.error("❌ Invalid JSON from Shiprocket");
      return null;
    }
