...
export const Route = createFileRoute("/policies/returns")({
  head: () => ({ meta: [{ title: "Return & Exchange Policy — First Smile" }] }),
  component: () => (
    <>
      ...
      <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <li>Alternatively, email <strong>support@toyhaat.com</strong> with your <strong>Order ID</strong>, <strong>full name</strong>, and <strong>registered phone number</strong>.</li>
      ...
      <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <li>Email support@toyhaat.com with order ID and proof.</li>
      </ul>
