  ...
  component: () => (
    <div className="space-y-6 selection:bg-primary/10">
      ...
      <div className="space-y-2">
        <h2 className="text-base    text-foreground uppercase tracking-wider m-0">Order Processing</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base    text-foreground uppercase tracking-wider m-0">Shipping Charges</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base    text-foreground uppercase tracking-wider m-0">Order Tracking</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base    text-foreground uppercase tracking-wider m-0">Shipping Coverage</h2>
