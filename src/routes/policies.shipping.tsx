  ...
  component: () => (
    <div className="space-y-6 selection:bg-primary/10">
      <div className="flex items-center gap-2.5 border-b pb-4 border-border/50">
        ...
        <h1 className="text-2xl font-bold text-foreground m-0">Shipping Policy</h1>
      </div>
      ...
      <div className="space-y-2">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Order Processing</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Delivery Time</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
          <li>Metro cities: <strong>2–4 business days</strong></li>
          <li>Other locations: <strong>3–7 business days</strong></li>
        </ul>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Shipping Charges</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Order Tracking</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Shipping Coverage</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Delays</h2>
        ...
        <p className="text-xs text-muted-foreground font-bold bg-muted/40 p-2.5 rounded-md border border-border/30 inline-block mt-1.5">
      ...
      <div className="bg-amber-50/60 border border-amber-100 text-amber-900 p-4 rounded-xl flex flex-col gap-1">
        <h3 className="text-xs font-bold uppercase tracking-wider text-amber-800 m-0">Important Note</h3>
        <p className="text-sm text-amber-900/80 font-medium m-0 leading-relaxed">
          Please make sure your address and contact details are correct while placing the order to avoid delivery issues.
        </p>
      </div>
      ...
      <div className="bg-muted/50 p-5 rounded-2xl border border-border/50 mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground m-0 leading-relaxed">For any shipping-related queries, please reach out to us:</p>
        </div>
        <div className="space-y-1 text-xs text-foreground/90 font-bold shrink-0 sm:text-right">
          ...
          <p className="flex sm:justify-end items-center gap-1.5">
            ...
            <a href="https://wa.me/917827743263" className="text-primary hover:underline">+91 7827743263</a>
          </p>
        </div>
      </div>
    </div>
