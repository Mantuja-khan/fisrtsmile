    ...
    <div className="space-y-6 selection:bg-primary/10">
      ...
      <div className="space-y-2">
        ...
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
          ...
          <li>
            We reserve the right to refuse or cancel any order if misuse or suspicious activity is
            detected.
          </li>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        ...
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
          <li>
            Slight variations in color or design may occur due to lighting or screen differences.
          </li>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        ...
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
          <li>
            Your order is confirmed only after successful payment or verification (in case of Cash
            on Delivery).
          </li>
          <li>
            We reserve the right to cancel orders due to stock issues, pricing errors, or other
            reasons.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
          We accept secure online payments. Cash on Delivery (COD) may be available on selected
          orders. Any misuse of COD may lead to restrictions on future orders.
        </p>
      </div>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
          All returns and exchanges are handled as per our Return & Refund Policy. Customers are
          advised to read the policy before placing an order.
        </p>
      </div>
      ...
      <div className="bg-muted/50 p-5 rounded-2xl border border-border/50 mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="space-y-1 text-xs text-foreground/90    shrink-0 sm:text-right">
          ...
          <p>
            <span className="text-muted-foreground font-medium">Address:</span> Genesis Mall,
            Bhiwadi – 301019, RJ
          </p>
        </div>
      </div>
