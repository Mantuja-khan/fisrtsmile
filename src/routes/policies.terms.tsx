  ...
  component: () => (
    <div className="space-y-6 selection:bg-primary/10">
      <div className="flex items-center gap-2.5 border-b pb-4 border-border/50">
        ...
        <h1 className="text-2xl font-bold text-foreground m-0">Terms of Service</h1>
      </div>
      ...
      <div className="space-y-2">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">General Conditions</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Products & Information</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Order Acceptance</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Payments</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Shipping & Delivery</h2>
        <ul className="space-y-1.5 text-sm text-muted-foreground list-disc pl-5 leading-relaxed">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Returns & Exchanges</h2>
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
      ...
      <div className="bg-muted/50 p-5 rounded-2xl border border-border/50 mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-base font-bold text-foreground m-0 mb-1.5">Contact Information</h2>
