  ...
  component: () => (
    <div className="space-y-6 selection:bg-primary/10">
      <div className="flex items-center gap-2.5 border-b pb-4 border-border/50">
        ...
        <h1 className="text-2xl font-bold text-foreground m-0">Legal Notice</h1>
      </div>
      ...
      <div className="space-y-3 bg-muted/30 border border-border/30 p-4 rounded-xl">
        <h2 className="text-sm font-bold text-foreground uppercase tracking-wider m-0">Business Details</h2>
        <div className="space-y-1.5 text-sm text-muted-foreground">
          <p className="flex flex-wrap items-baseline gap-2">
            <span className="font-bold text-foreground/80">Business Name:</span> 
            <span>First Smile Toys</span>
          </p>
          <p className="flex flex-wrap items-baseline gap-2">
            <span className="font-bold text-foreground/80">Address:</span> 
          ...
          <p className="flex flex-wrap items-baseline gap-2">
            <span className="font-bold text-foreground/80">WhatsApp:</span> 
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Use of Website</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Product Information</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Intellectual Property</h2>
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Limitation of Liability</h2>
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Governing Law</h2>
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
      ...
      <div className="space-y-2 border-t border-border/30 pt-5">
        <h2 className="text-base font-bold text-foreground uppercase tracking-wider m-0">Updates to This Notice</h2>
        <p className="text-sm text-muted-foreground leading-relaxed m-0">
      ...
      <div className="bg-[#f0f9ff] border border-[#bae6fd] text-[#0369a1] p-5 rounded-2xl flex flex-col gap-2 mt-8">
        <h3 className="text-xs font-bold uppercase tracking-widest m-0">Contact Us</h3>
        ...
        <div className="space-y-1 text-xs mt-1">
          <p><span className="font-bold opacity-80">Email:</span> <a href="mailto:support@firstsmiletoys.com" className="underline hover:text-black">support@firstsmiletoys.com</a></p>
          <p><span className="font-bold opacity-80">Address:</span> Genesis Mall, Bhiwadi – 301019, Rajasthan, India</p>
        </div>
      </div>
    </div>
  ),
