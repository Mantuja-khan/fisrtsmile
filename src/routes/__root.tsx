        ...
        <ShopProvider>
          <div className="flex flex-col min-h-screen">
            ...
            <a 
              ...
              className="fixed bottom-20 md:bottom-6 right-6 z-50 flex items-center justify-center size-14 bg-[#25D366] text-white rounded-full shadow-2xl transition hover:scale-110 active:scale-90"
