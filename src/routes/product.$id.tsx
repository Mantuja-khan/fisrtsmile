        ...
        <div>
          ...
          <div className="mt-3 flex items-baseline gap-3 flex-wrap">
            ...
            {product.badge && String(product.badge).split(",").filter(Boolean).map((b) => (
              <span key={b} className="text-xs    uppercase px-2.5 py-0.5 rounded bg-amber-100 text-amber-800 flex items-center gap-1 border border-amber-200 shadow-xs">
          ...
          {(product.weight || product.length) && (
            <div className="mt-5 p-3 bg-slate-50 rounded-xl border border-slate-100">
              <h3 className="text-xs    uppercase tracking-wider text-slate-500 mb-2">Specifications</h3>
          ...
          {product.ageRange && (
            <div className="mt-4 pt-4 border-t border-slate-100">
              <span className="text-xs    text-slate-500 uppercase tracking-wider block mb-2">Recommended Age Range</span>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              {[
                ...
                <div key={b.t} className={`flex items-center gap-2 px-2.5 py-2.5 rounded-lg border shadow-xs text-[11px]    leading-none ${b.c}`}>
