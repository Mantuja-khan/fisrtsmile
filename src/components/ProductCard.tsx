  ...
  return (
    <div className="product-card group relative bg-white border border-gray-100 rounded shadow-sm flex flex-col text-center h-full overflow-hidden hover:shadow-md transition-all duration-300">
      ...
      <div className="absolute top-2 sm:top-3 left-0 z-10 flex flex-col gap-1 items-start">
        {product.isSale && (
          <span className="text-[9px] sm:text-[10px] font-black uppercase bg-[#E43E3D] text-white px-1.5 sm:px-2 py-0.5 shadow-sm animate-[pulse_0.8s_infinite] tracking-wider">
            ⚡ Flash Sale
          </span>
        )}
        {product.offerPct > 0 && (
      ...
      <div className="p-1.5 sm:p-2.5 flex flex-col flex-1 justify-between">
        ...
        <Link
          ...
          className="text-[11px] sm:text-[13px] font-medium text-gray-700 hover:text-[#E43E3D] line-clamp-2 leading-relaxed mb-1 sm:mb-1.5 transition-colors min-h-[2rem] sm:min-h-[2.3rem] flex items-center justify-center px-0.5"
        >
